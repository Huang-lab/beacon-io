...
[![CI](https://github.com/Huang-lan/beacon-io/actions/workflows/ci.yml/badge.svg)](https://github.com/Huang-lan/beacon-io/actions/workflows/ci.yml)
...
```bash
# Clone
git clone https://github.com/Huang-lan/beacon-io.git
cd beacon-io
